...
- [What is ClassLoader? What are the types of class loaders?](core.md#what-is-classloader-what-are-the-types-of-class-loaders)
...
- [How did the internal implementation of ConcurrentHashMap change before and after Java 8?](concurrency.md#how-did-the-internal-implementation-of-concurrenthashmap-change-before-and-after-java-8)
...
- [Are there any potential differences between the declarative way (using @Transactional annotation) and the programmatic way (using TransactionTemplate) of using transactions in Spring? Which is preferable?](spring.md#are-there-any-potential-differences-between-the-declarative-way-using-transactional-annotation-and-the-programmatic-way-using-transactiontemplate-of-using-transactions-in-spring-which-is-preferable)
...
- [Why is Lombok's @Data annotation dangerous for Java entities?](hibernate.md#why-is-lomboks-data-annotation-dangerous-for-java-entities)
...
- [Does it make sense to add an index on a column with a highly skewed distribution to selectively query the minority value?](sql.md#does-it-make-sense-to-add-an-index-on-a-column-with-a-highly-skewed-distribution-to-selectively-query-the-minority-value)
...
- [What are the main types of NoSQL databases, and when is each type most useful?](sql.md#what-are-the-main-types-of-nosql-databases-and-when-is-each-type-most-useful)
...
- [What is the difference between optimistic and pessimistic locking, and which should you use when?](transaction.md#what-is-the-difference-between-optimistic-and-pessimistic-locking-and-which-should-you-use-when)
