...
- [Требования к транзакции? для чего нужны?](#требования-к-транзакции-для-чего-нужны)
- [что такое распределенная транзакция?](#что-такое-распределенная-транзакция)
...
- [Возможные варианты реализации транзакционности в микросервисах](#возможные-варианты-реализации-транзакционности-в-микросервисах)
- [В чем разница между optimistic и pessimistic locking?](#в-чем-разница-между-optimistic-и-pessimistic-locking)
- [Что такое Eventual consistency?](#что-такое-eventual-consistency)
